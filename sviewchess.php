...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `chess` WHERE CONCAT(`crn`,`playername`, `batch`,`faculty`,`position`,`username`) LIKE '%".$valueToSearch."%'";
  ...
  {
 $query = "SELECT * FROM chess WHERE username='{$_SESSION['username']}'";
 $search_result = filterTable($query);
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="sviewchess.php" method="POST">
