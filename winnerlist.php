...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `winner` WHERE CONCAT(`CRN`, `batch`, `playername`, `faculty`,`position`,`game`) LIKE '%".$valueToSearch."%'";
  ...
  {
 $query = "SELECT * FROM winner JOIN coordinator WHERE winner.game=coordinator.game";
 $search_result = filterTable($query);
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="winnerlist.php" method="POST">
      ...
      <div><a class="btn btn-success" href="winner.php">Add winner</a></div>
    </form>
  </div>
</nav>
...
function fetch_data()  
 {  
      $output = '';  
      $connect = mysqli_connect("localhost", "root", "", "sports");  
      $sql = "SELECT * FROM winner JOIN coordinator WHERE winner.game=coordinator.game";  
...
$content = '';  
$content .= '  
<h4 align="center">WINNER LIST</h4><br /> 
...
<th width="10%">Game</th>  
<th width="15%">Coordinator Name</th>  
