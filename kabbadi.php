...
<head>
    ...
    <!-- Title Page-->
    <title>Register Team for kabbadi</title>
...
<body>
    <form name="kabbadi" action="" method="GET">   
...
<br>
            <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input type="text" class="input--style-5" name="game[]" value="kabbadi" readonly required>
                                </div>
                            </div>
                        </div>
...
if (isset($_GET['submit']))
{
        ...
        $sql="SELECT crn,username FROM kabbadi";
        ...
        for ($i=0; $i<7; $i++) 
        {
        $query="INSERT INTO kabbadi(faculty,batch,playername,crn,captain,coach,username,game,teamname) VALUES ('".$_GET['faculty'][0]."','".$_GET['batch'][0]."','".$_GET['playername'][$i]."','".$_GET['crn'][$i]."','".$_GET['captain'][0]."','".$_GET['coach'][0]."','".$_GET['username'][0]."','".$_GET['game'][0]."','".$_GET['teamname'][0]."')";
