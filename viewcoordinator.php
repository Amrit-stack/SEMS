...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `coordinator` WHERE CONCAT(`CRN`, `Name`, `Faculty`, `Mobilenumber`,`Gametype`) LIKE '%".$valueToSearch."%'";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="viewcoordinator.php" method="POST">
