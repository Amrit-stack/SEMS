...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `subcoordinator` WHERE CONCAT(`CRN`, `Name`, `Faculty`, `Mobilenumber`,`Gametype`) LIKE '%".$valueToSearch."%'";
...
<html>
<head>
  <title>VIEW SUBCOORDINATORS</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="viewsubcoordinator.php" method="POST">
