...
<head>
    ...
    <!-- Title Page-->
    <title>Register  for highjump</title>
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">highjump  Registration Form</h2>
                </div>
                    <div class="form-row">
            ...
            <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input type="text" class="input--style-5" name="game" value="highjump" readonly required>
                                </div>
                            </div>
                        </div>
                        <br>
...
if(isset($_GET['submit']))
{
    ...
    $game=$_GET['game'];
    $sql="SELECT *FROM highjump where crn='$crn'";
...
if($GLOBALS==0)
{    
    $insert_student=" INSERT INTO highjump(faculty,batch,playername,crn,username,game)values('$faculty','$batch','$playername','$crn','$username','$game')";
