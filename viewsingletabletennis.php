...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `tabletennissingle` WHERE CONCAT(`crn`,`playername`, `batch`,`faculty`,`position`) LIKE '%".$valueToSearch."%'";
  ...
  {
 $query = "SELECT * FROM tabletennissingle";
 $search_result = filterTable($query);
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">Tabletennis</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="viewsingletabletennis.php" method="POST">
...
<td><a href='deletesingletabletennis.php?crn={$row["crn"]}' class='btn btn-danger'>Delete</a> </td>
<td><a href='addstabletennis.php?crn=$row[crn]&name=$row[playername]&fl=$row[faculty]&bt=$row[batch]&ps=$row[position]' class='btn btn-danger'>Make Winner</a> </td>
</tr>
";
?>
</tr>
