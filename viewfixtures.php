...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `fixture` WHERE CONCAT(`game`,`fixture`,`venue`,`time`,`date`,`gamelevel`) LIKE '%".$valueToSearch."%'";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark"> 
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="viewfixtures.php" method="POST">
