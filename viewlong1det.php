...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `longjump` WHERE CONCAT(`crn`,`playername`, `batch`,`faculty`,`position`) LIKE '%".$valueToSearch."%'";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">Longjump</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="viewlong1det.php" method="POST">
...
<td><a href='deletelongjump.php?crn={$row["crn"]}' class='btn btn-danger'>Delete</a> </td>
<td><a href='addlongjumpwinner.php?crn=$row[crn]&name=$row[playername]&fl=$row[faculty]&bt=$row[batch]&ps=$row[position]' class='btn btn-danger'>Make Winner</a> </td>
</tr>
";
?>
</tr>
...
$obj_pdf->SetTitle("LONGJUMP PLAYERS LIST");  
...
$content = '';  
$content .= '  
<h4 align="center">LONGJUMP PLAYERS</h4><br /> 
