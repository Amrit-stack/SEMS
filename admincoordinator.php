...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="admincoordinator.php" method="POST">
...
<td>{$row["game"]}</td>
<td><a href='deleteadmincoordinator.php? CRN={$row["CRN"]}' class='btn btn-danger'>Delete</a> </td>
