...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="adminvolunteer.php" method="POST">
      ...
      <div><a class="btn btn-success" href="volunteer.php">Add volunteer</a></div>
    </form>
  </div>
</nav>
...
<td>{$row["Gametype"]}</td>
<td><a href='deleteadminvolunteer.php? CRN={$row["CRN"]}' class='btn btn-danger'>Delete</a> </td>
</tr>
";
?>
</tr>
