...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="adminviewfixtures.php" method="POST">
      ...
      <div><a class="btn btn-success" href="footdet.php">Add fixtures</a></div>
...
<td><a href='updatefixture.php?SN=$row[SN]&fix=$row[fixture]&ven=$row[venue]&ti=$row[time]&dat=$row[date]&gam=$row[game]&gl=$row[gamelevel]&wt=$row[winnerteam]' class='btn btn-danger'>Update</a></td>
<td><a href='deletefixture.php? SN={$row["SN"]}' class='btn btn-danger'>Delete</a> </td>
</tr>
";
?>
</tr>
