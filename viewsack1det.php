...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `sackrace` WHERE CONCAT(`crn`,`playername`, `batch`,`faculty`,`position`) LIKE '%".$valueToSearch."%'";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">Sackrace</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="viewsack1det.php" method="POST">
...
<td><a href='deletesackrace.php?crn={$row["crn"]}' class='btn btn-danger'>Delete</a> </td>
<td><a href='addsackracewinner.php?crn=$row[crn]&name=$row[playername]&fl=$row[faculty]&bt=$row[batch]&ps=$row[position]' class='btn btn-danger'>Make Winner</a> </td>
</tr>
";
?>
</tr>
...
$obj_pdf->SetTitle("SACKRACE PLAYERS LIST");  
...
$content = '';  
$content .= '  
<h4 align="center">SACKRACE PLAYERS</h4><br /> 
