...
<head>
    ...
    <!-- Title Page-->
    <title>Register Team for football</title>
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Football Team Registration Form</h2>
                </div>
                    <div class="form-row">
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="playername" value="<?php echo $_GET['name'];?>"required="">
                                            <label class="label--desc">Name</label>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="number" name="crn" value="<?php echo $_GET['CRN'];?>"required="">
...
<div>
          ...
          <a href="teamA.php?CRN=$row[CRN]&name=$row[username]&fl=$row[faculty]&bt=$row[batch]" class="btn btn--radius-2 btn--red">REGISTER</a>
    </div>
                        <br>
                        <div>
                            <a href="teamgame.php" class="btn btn--radius-2 btn--red"  >Back</a>
                        </div>
...
$query="INSERT INTO football(faculty,batch,playername,crn,captain,coach) VALUES ('$faculty','$batch','$playername','$CRN','$Captain','$Coach')";
mysqli_query($db,$query);

?>
<script type="text/javascript">
    alert("Registration successful");
    window.open("teamA.php");
 </script>
<?php
}
 ?>