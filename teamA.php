...
<?php endif; ?>
          ...
          <?php 
            ...
            <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input type="text" class="input--style-5" name="game[]" value="football" readonly required>
                                </div>
                            </div>
                        </div>
...
$sql="SELECT crn,username FROM football";
...
$query="INSERT INTO football(faculty,batch,playername,crn,captain,coach,username,game,teamname) VALUES ('".$_GET['faculty'][0]."','".$_GET['batch'][0]."','".$_GET['playername'][$i]."','".$_GET['crn'][$i]."','".$_GET['captain'][0]."','".$_GET['coach'][0]."','".$_GET['username'][0]."','".$_GET['game'][0]."','".$_GET['teamname'][0]."')";
