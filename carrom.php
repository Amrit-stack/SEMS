...
<head>
    ...
    <!-- Title Page-->
    <title>Register Team for carrom</title>
...
<body>
    <form name="carrom" action="" method="GET">   
...
<?php endif; ?>
          ...
          <?php 
            ...
            <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input type="text" class="input--style-5" name="game[]" value="carrom" readonly required>
                                </div>
                            </div>
                        </div>
...
$sql="SELECT crn,username FROM carrom";
...
$query="INSERT INTO carrom(faculty,batch,playername,crn,captain,coach,username,game,teamname) VALUES ('".$_GET['faculty'][0]."','".$_GET['batch'][0]."','".$_GET['playername'][$i]."','".$_GET['crn'][$i]."','".$_GET['captain'][0]."','".$_GET['coach'][0]."','".$_GET['username'][0]."','".$_GET['game'][0]."','".$_GET['teamname'][0]."')";
