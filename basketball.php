...
<head>
    ...
    <!-- Title Page-->
    <title>Register Team for basketball</title>
...
<body>
    <form name="basketball" action="" method="GET">   
...
<br>
            <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input type="text" class="input--style-5" name="game[]" value="basketball" readonly required>
                                </div>
                            </div>
                        </div>
...
if (isset($_GET['submit']))
{
        ...
        $sql="SELECT crn,username FROM basketball";
        ...
        for ($i=0; $i<5; $i++) 
        {
        $query="INSERT INTO basketball(faculty,batch,playername,crn,captain,coach,username,game,teamname) VALUES ('".$_GET['faculty'][0]."','".$_GET['batch'][0]."','".$_GET['playername'][$i]."','".$_GET['crn'][$i]."','".$_GET['captain'][0]."','".$_GET['coach'][0]."','".$_GET['username'][0]."','".$_GET['game'][0]."','".$_GET['teamname'][0]."')";
