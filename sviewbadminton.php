...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `badmintonsingle` WHERE CONCAT(`crn`,`playername`, `batch`,`faculty`,`position`,`username`) LIKE '%".$valueToSearch."%'";
  ...
  {
 $query = "SELECT * FROM badmintonsingle WHERE username='{$_SESSION['username']}'";
 $search_result = filterTable($query);
}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">badmintonsingle</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="sviewbadminton.php" method="POST">
...
<td><a href='deletesbadmintonsingle.php?crn={$row["crn"]}' class='btn btn-danger'>Delete</a> </td>
