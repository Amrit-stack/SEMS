...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `carromsingle` WHERE CONCAT(`crn`,`playername`, `batch`,`faculty`,`position`) LIKE '%".$valueToSearch."%'";
  ...
  {
 $query = "SELECT * FROM carromsingle";
 $search_result = filterTable($query);
}
...
<html>
<head>
  <title> SINGLE CARROM PLAYERS</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">Carrom</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="viewsinglecarrom.php" method="POST">
...
<td><a href='deletesinglecarrom.php?crn={$row["crn"]}' class='btn btn-danger'>Delete</a> </td>
<td><a href='addscarromwinner.php?crn=$row[crn]&name=$row[playername]&fl=$row[faculty]&bt=$row[batch]&ps=$row[position]' class='btn btn-danger'>Make Winner</a> </td>
</tr>
";
?>
</tr>
...
$obj_pdf->SetTitle("SINGLE CARROM PLAYERS LIST");  
...
$content = '';  
$content .= '  
<h4 align="center">SINGLE CARROM PLAYERS</h4><br /> 
