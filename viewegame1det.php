...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `egame` WHERE CONCAT(`crn`,`playername`, `batch`,`faculty`,`position`) LIKE '%".$valueToSearch."%'";
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">Egame</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="viewegame1det.php" method="POST">
...
<td><a href='deleteegame.php?crn={$row["crn"]}' class='btn btn-danger'>Delete</a> </td>
<td><a href='addegamewinner.php?crn=$row[crn]&name=$row[playername]&fl=$row[faculty]&bt=$row[batch]&ps=$row[position]' class='btn btn-danger'>Make Winner</a> </td>
</tr>
";
?>
</tr>
...
$obj_pdf->SetTitle("EGAME PLAYERS LIST");  
...
$content = '';  
$content .= '  
<h4 align="center">EGAME PLAYERS</h4><br /> 
