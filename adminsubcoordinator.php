...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM subcoordinator";
    $search_result = filterTable($query);
}
...
<html>
<head>
  <title>VIEW SUBCOORDIANTORS</title>
</head>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">subcoordinatorS</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" action="adminsubcoordinator.php" method="POST">
      <input class="form-control mr-sm-2" type="text" placeholder="Search" aria-label="Search" name="valueToSearch">
      <a href="subcordet.php" class='btn btn-success'>Add subcoordinator</a>
...
<td>{$row["game"]}</td>
<td><a href='deleteadminsubcoordinator.php? CRN={$row["CRN"]}' class='btn btn-danger'>Delete</a> </td>
...
function fetch_data()  
 {  
      $output = '';  
      $connect = mysqli_connect("localhost", "root", "", "sports");  
      $sql = "SELECT * FROM subcoordinator";  
...
$obj_pdf->SetTitle("  subcoordinator LIST");  
...
$content = '';  
$content .= '  
<h4 align="center">subcoordinator LIST</h4><br /> 
